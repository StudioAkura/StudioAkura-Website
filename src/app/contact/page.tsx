      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-zinc-400 font-light max-w-2xl mx-auto">
            For business inquiries, press, or general support, please transmit your message below.
          </p>
        </motion.div>
        ...
        >
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-zinc-500">Email Vector</label>
                <input 
                  type="email" 
                  className="w-full bg-zinc-950 border border-zinc-800 focus:border-red-600 px-4 py-3 text-white outline-none transition-colors"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-500">Transmission Subject</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-500">Message Body</label>
              <textarea 
                rows={6}
